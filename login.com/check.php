...
$flag_text=0;$flag_pass=0;$flag_cap=0;
$cap=0;$small=0;$digit=0;$special=0;
$pat1="/106120\d\d\d/";
$pat2="/111120\d\d\d/";
$pat3="/102120\d\d\d/";
$pat4="/103120\d\d\d/";
if($_GET['cap'] == $_SESSION['value'] )
$flag_cap=1;
...
{if($flag_text==0)
$_SESSION['flash'].="Invalid name<br>";
if($flag_pass==0)
$_SESSION['flash'].="Invalid password<br>";
if($flag_cap==0)
$_SESSION['flash'].="Invalid captcha";
